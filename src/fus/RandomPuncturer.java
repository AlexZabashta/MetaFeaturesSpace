...
public class RandomPuncturer implements AttributePuncturer {
	final Random random;
	...
	@Override
	public Instances select(Instances oldInstances) {
		...
		int newAttributes = random.nextInt(oldAttributes) + 1;
