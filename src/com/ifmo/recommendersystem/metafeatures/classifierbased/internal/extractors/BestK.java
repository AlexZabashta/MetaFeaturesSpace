...
public class BestK implements Extractor {
    ...
    private double calculateF1Measure(Evaluation evaluation) {
        ...
        double precision = IntStream.range(0, numClasses).mapToDouble(evaluation::precision).average().getAsDouble();
        double recall = IntStream.range(0, numClasses).mapToDouble(evaluation::recall).average().getAsDouble();
